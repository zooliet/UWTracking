...
class Motor():
    ...
    def __init__(self, dev, baud = 115200, screen_width = 640):
        ...
        self.SPEEDS = {
            1: (64000*2//3, 36000*2//3),
          1.4: (64000*2//3, 36000*2//3),
          1.7: (64000*2//3, 36000*2//3),
            2: (48000*2//3, 27000*2//3),
            3: (48000*2//3, 27000*2//3),
            4: (48000*2//3, 27000*2//3),
            5: (48000*2//3, 27000*2//3),
            6: (48000*2//3, 27000*2//3),
            7: (48000*2//3, 27000*2//3),
            8: (40000*2//3, 22500*2//3),
            9: (40000*2//3, 22500*2//3),
           10: (36000*2//3, 20250*2//3),
           11: (36000*2//3, 20250*2//3),
           12: (24000*2//3, 13500*2//3),
           13: (24000*2//3, 13500*2//3),
           14: (24000*2//3, 13500*2//3),
           15: (24000*2//3, 13500*2//3),
           16: (24000*2//3, 13500*2//3)
        }
